...
class OrderFragment : Fragment() {
    ...
    private val args: com.hdsturkey.yalovabsm404.firstassignment.fragments.OrderFragmentArgs by navArgs()
    ...
    private fun goNextScreen() {
        val action = com.hdsturkey.yalovabsm404.firstassignment.fragments.OrderFragmentDirections.actionOrderFragmentToOrderDetailFragment()
