package com.hdsturkey.yalovabsm404.firstassignment.fragments
...
class SignupFragment : Fragment() {
    ...
    private fun isInputsValid(): Boolean {
        mBinding.etName.setText("Huseyin")
        mBinding.etSurname.setText("Oral")
        mBinding.etEmail.setText("askdsakask@yalova.edu.tr")
        mBinding.etPassword.setText("1234567897")
    ...
    private fun goNextScreen() {
        ...
        val action =
            com.hdsturkey.yalovabsm404.firstassignment.fragments.SignupFragmentDirections.actionSignupFragmentToOrderFragment(
                userNameSurname,
                email
            )
